...
(async () => {
  ...
  await fs.writeFile("cerebral-arteritis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("cerebral-arteritis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
